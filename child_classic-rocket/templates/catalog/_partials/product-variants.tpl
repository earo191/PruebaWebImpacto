      ...
      {elseif $group.group_type == 'color'}
        <div class="row">
          <div class="col-xs-12 col-sm-12 ">
            <div class="label info"><b>{$group.name} Técnico:</b></div>
          </div>
          <div class="clearfix">
          <div class="col-xs-12 col-sm-12 color_option">
            {foreach from=$group.attributes key=id_attribute item=group_attribute}
              
                <label class="label-color label_info">
                  ...
                  <span
                    {if $group_attribute.html_color_code && !$group_attribute.texture}class="color radio_info" style="background-color: {$group_attribute.html_color_code}" {/if}
